...
public class guanlisushe extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		susheclass s = susheDao.findSusheByid(stuNum);
		//System.out.println(s);
		//request.setAttribute("student", s);
		request.getSession().setAttribute("sushe", s);
		response.sendRedirect("sushe_guanli.jsp");
